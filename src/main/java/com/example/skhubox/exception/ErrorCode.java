...
public enum ErrorCode {
    ...
    EMAIL_SEND_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "U007", "이메일 전송에 실패했습니다."),
    INVALID_VERIFICATION_CODE(HttpStatus.BAD_REQUEST, "U008", "인증 코드가 일치하지 않거나 만료되었습니다."),
    EMAIL_NOT_VERIFIED(HttpStatus.BAD_REQUEST, "U009", "이메일 인증이 완료되지 않았습니다."),
